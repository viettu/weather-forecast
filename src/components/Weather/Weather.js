        ...
        <Container className="Weather-container" fluid>
            ...
            <Row className="justify-content-md-center">
                <Col md={9} lg={6} xl={4} className="Weather-search">
                    <Search onSearch={setLocation} placeholder="Enter a location... Ex. Ho Chi Minh City" />
                </Col>
            </Row>
            { isLoading && (
                <Row className="justify-content-md-center">
                    <Col> <Spinner animation="border" variant="primary" /> </Col>
                </Row>
            )}
            <Row className="justify-content-md-center">
                <Col md={8} className="Weather-list">
                    {error && (
                        <div className="Weather-error">{`Something went wrong when loading ${locationTitle || location}. Please try again later!`}</div>
                    )}
